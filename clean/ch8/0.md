...
<ins>如何做到？
通过恰当地分离因不同原因而变化的部分（SRP 原则），然后正确地组织这些部分之间的依赖关系（DIP 原则）</ins>。

<ins>通过应用 SRP，我们可能会得到如 [Fig 8.1](#fig-81) 所示的数据流视图</ins>。
...
<ins>请注意，这如何根据 “层次” 的概念创建了一个保护层次结构</ins>。
