...
由此延伸，缩写 MD(S)E 亦可解读为 “*模型驱动万物 (Model-Driven Everything)*”；MDSE 理念可适用于任何软件工程任务。本章将聚焦三个主要应用场景，阐释 MDSE 如何满足不同需求。<ins>除软件开发场景外，我们将描述 MDSE 在逆向工程与软件现代化领域的应用，探讨工具/系统互操作性问题，并延伸至组织层面，揭示模型在纯软件系统之外的组织应用价值</ins>。
