...
* [第 2 章 MDSE 原理](ch2/0.md)
  ...
  - [2.4 工具支持](ch2/4.md)
    ...
    * [2.4.2 基于模型的与基于编程的 MDSE 工具](ch2/4.md#242-基于模型的与基于编程的-mdse-工具)
...
* [第 7 章 开发自己的建模语言](ch7/0.md)
  ...
  - [7.5 真实世界案例：IFML](ch7/5.md)
    ...
    * [7.5.4 IFML 元模型](ch7/5.md#754-ifml-元模型)
...
* [第 8 章 模型间转换](ch8/0.md)
  ...
  - [8.4 掌握模型转换](ch8/4.md)
    ...
    * [8.4.2 热点：万物皆模型，包括转换](ch8/#842-hot万物皆模型包括转换)
...
* [第 10 章 模型管理](ch10/0.md)
  ...
  - [10.7 模型质量](ch10/7.md)
    * [10.7.1 模型验证](ch10/7.md#1071-模型验证)
    * [10.7.2 模型测试与验证](ch10/7.md#1072-模型测试与验证)
    * [10.7.3 模型审查](ch10/7.md#1073-模型审查)
  - [10.8 协作建模](ch10/8.md)
* [第 11 章 总结](ch11/0.md)
