...
## 将需求转化为只读资源 <a id="requirement-to-resource"></a>
...
## 将数据集拆分为资源 <a id="dataset-to-resource"></a>
...
## 设计你的表述 <a id="design-representation"></a>
