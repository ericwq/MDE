...
`SIDE-EFFECT-FREE FUNCTIONS`，尤其是在不可变的 [VALUE OBJECTS](../ch5/3.md) 中，允许安全地组合操作。当一个`FUNCTION`通过 [INTENTION-REVEALING INTERFACE](../glossary.md#intention-revealing-interface) 呈现时，开发者可以在不了解其具体实现的情况下使用它。
