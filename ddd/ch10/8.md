...
一旦你的设计具备了 [INTENTION-REVEALING INTERFACES](1.md) 、`SIDE-EFFECT-FREE FUNCTIONS`以及`ASSERTIONS`，你就已经接近声明式领域了。一旦你拥有可组合的元素，这些元素能够传达它们的意义，并且具有特征化或显而易见的效果，或者根本没有可观察的效果，声明式设计的许多好处便会体现出来。
