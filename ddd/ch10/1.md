...
整个子域可以被拆分成独立的模块，并封装在  [INTENTION-REVEALING INTERFACES](../glossary.md#intention-revealing-interface) 之后。如何利用这种拆分来聚焦项目并管理大型系统的复杂性将在 [第 15 章](../ch15/0.md) “提炼” 中进一步讨论，涉及`COHESIVE MECHANISMS`和`GENERIC SUBDOMAINS`。
