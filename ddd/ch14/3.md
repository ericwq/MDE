...
`Routing Service`是一个 [SERVICE](../ch5/4.md) ，它封装了一个机制，该机制通过由 [SIDE-EFFECT-FREE FUNCTIONS](../glossary.md#side-effect-free-function) 组成的 [INTENTION-REVEALING INTERFACE](../ch10/1.md) 来实现。这些函数的结果以 `ASSERTIONS` 为特征。
