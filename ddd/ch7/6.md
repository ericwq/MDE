...
设计中有五个 [ENTITIES](../ch5/2.md) 作为 [AGGREGATES](../ch6/1.md) 的根节点，因此我们可以将考虑范围限定于这些实体，因为其他对象均不允许拥有`REPOSITORIES`。
...
*Figure 7.4：`REPOSITORIES`提供对选定 [AGGREGATE](../ch6/1.md) 根节点的访问。*
