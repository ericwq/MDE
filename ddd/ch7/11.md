...
*Figure 7.9：我们的`Booking Application`必须使用来自`Sales Management System`和我们自身领域 [REPOSITORIES](../ch6/3.md) 的信息。*
...
*Figure 7.10：`Allocation Checker`作为 [ANTICORRUPTION LAYER](../ch14/8.md) ，在领域模型层面为`Sales Management System`提供了一个选择性接口。*
