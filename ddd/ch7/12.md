...
就这样。这次集成本可能将我们简单而概念一致的设计变成一团乱麻，但如今借助`ANTICORRUPTION LAYER`、[SERVICE](../ch5/4.md) 和若干`ENTERPRISE SEGMENTS`，我们已将`Sales Management System`功能干净利落地整合到预订系统中，并丰富了领域模型。
