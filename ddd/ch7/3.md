...
这点颇为棘手。`Delivery Histories`不可互换，因此属于 [ENTITIES](../ch5/2.md) 。但每个`Delivery History`与其`Cargo`存在一对一关系，故其本身并无独立身份。其身份实则承袭自所属`Cargo`。待我们建模 [AGGREGATES](../ch6/1.md) 时，此点将更为清晰。
